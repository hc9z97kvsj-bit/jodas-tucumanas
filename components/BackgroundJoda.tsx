...
export default function BackgroundJoda() {
  return (
    <div className="fixed inset-0 z-[-1] overflow-hidden bg-night-900">
      ...
      {/* CAPA 3: LUCES NEÓN (Azul y Rojo de tu paleta) */}
      <div className="absolute top-[-10%] left-[-10%] w-[50vw] h-[50vw] rounded-full bg-[#2500FA]/20 blur-[120px] animate-blob"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-[50vw] h-[50vw] rounded-full bg-[#FF0A23]/15 blur-[120px] animate-blob" style={{ animationDelay: '5s' }}></div>

      {/* CAPA 4: EFECTO GLITCH */}
      <div
